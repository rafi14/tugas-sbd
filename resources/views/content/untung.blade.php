...
<div class="main-page-charts">
   <div class="main-page-chart-layer1">
		<div class="col-md-6 chart-layer1-right" style="margin-left:220px;"> 
			<h3>Emang ada ya untung nya kita belajar Sistem Basis Data?????</h3><br>
            <img src="{{asset('images/mikir.gif')}}" alt="">
		</div>
 ...
 <center><a target="_blank" href="{{route('dashboard.manfaat')}}">www.ManfaatBlajarSBD.com</a></center>
